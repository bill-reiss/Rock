...
internal sealed class SqlSchemaProvider
{
    ...
    public async Task<SchemaDefinition> GetSchemaAsync(string key, string? description, params string[] tableNames)
    {
        ...
        return new SchemaDefinition(key, "Microsoft SQL Server", description, tables);
    }
