...
#pragma warning restore SKEXP0001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
        ...
        public async Task<string> QueryAsync([Description("What to query")] string prompt, [Description("The kernel instance")] Kernel kernel, [Description("Country")]string country)
        {
            if (!_initialized)
            {
                _initialized = true;
